...
public class BlankFragment3 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.activiti_feed, container, false);
        listView = view.findViewById(R.id.ListView3);
        list.add(new Product(R.drawable.myimg, "Header", "He'll want to use your yacht, and I don't want this thing smelling like fish.", "8ago"));
        list.add(new Product(R.drawable.myimg, "Header", "He'll want to use your yacht, and I don't want this thing smelling like fish.", "8ago"));
        list.add(new Product(R.drawable.myimg, "Header", "He'll want to use your yacht, and I don't want this thing smelling like fish.", "8ago"));
        list.add(new Product(R.drawable.myimg, "Header", "He'll want to use your yacht, and I don't want this thing smelling like fish.", "8ago"));
        list.add(new Product(R.drawable.myimg, "Header", "He'll want to use your yacht, and I don't want this thing smelling like fish.", "8ago"));
